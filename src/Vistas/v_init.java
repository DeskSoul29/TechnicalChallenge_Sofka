...
public class v_init extends javax.swing.JFrame {
    ...
    public v_init() {
        ...
        initComponents();
        PlaceHolders place = new PlaceHolders("Please enter your name", jTextField1);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(v_init.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
