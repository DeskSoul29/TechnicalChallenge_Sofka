...
public class v_exit extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(v_exit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    class Fondo_menu extends JPanel{
        ...
        public void paint (Graphics g){
            Imagen = new ImageIcon(getClass().getResource("/Images/gameover.jpg")).getImage(); //cambiamos el fondo del menu por una imagen
